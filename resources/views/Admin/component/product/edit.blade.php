            ...
            <div class="min-height-200px">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">
                                        <form action="{{route('admin.product.destroy',$item->id)}}" method="post" style="display: inline">
                                            @csrf
                                            @method('DELETE')
                                            <button class="breadcrumb-item active " style="border: none">Delete</button>
                                        </form>
                                    </li>
                                    <li class="breadcrumb-item " aria-current="page">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <div class="">
                        ...
                        <form class="p-5" method="post" action="{{route('admin.product.update',$id)}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{$item->auction_end_time?\Illuminate\Support\Carbon::parse($item->auction_end_time)->format('Y-m-d\TH:i'):""}}"
                                            />
                                            @if($errors->has('date'))
                                                <em class="invalid-feedback">
                                                    {{ $errors->first('date') }}
                            ...
                            <section class=" my-3">
                               <textarea name="contextBig"
                                         class="form-control inputFields ncontent">
                                   {!! $item->description !!}
                               </textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="imgText"
                                                      class="form-control ">{{$other->imgText ?? ' '}}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="youtubUrl" value="{{$other->youtubUrl?? ' '}}"
                                                   class="form-control"/>
                                ...
                                <section class=" my-3">
                                    ...
                                    <div class="col-md-6  m-auto">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <img width="200px" src="{{isset($other->underImages)?asset($other->underImages):''}}" alt="">

                                                    <label>under Images :</label>
                                                    <input type="file" name="underImages" class="form-control"/>
                                                    @if($errors->has('underImages'))
                                                        <em class="invalid-feedback">
                                                            {{ $errors->first('underImages') }}
                                                        </em>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <img width="200px"
                                                         src="{{isset($other->coverImages)?asset($other->coverImages):''}}"
                                                         alt="">

                                                    <label>Cover top Images :</label>
                                                    <input type="file" name="coverImages" class="form-control"/>
                                                    @if($errors->has('coverImages'))
                                                        <em class="invalid-feedback">
                                                            {{ $errors->first('coverImages') }}
                                                        </em>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label>Cover middle of :</label>
                                                    <input type="file" name="middle_picture" class="form-control"/>
                                                    @if($errors->has('middle_picture'))
                                                        <em class="invalid-feedback">
                                                            {{ $errors->first('middle_picture') }}
                                                        </em>
                                                    @endif
                                                </div>
                                            </div>
                ...
                <table class="table">
                    @foreach($itemGallery as $Gallery)
                        <tr>
                            <td><img width="200px" src="{{asset($Gallery->image_path)}}" alt=""></td>
                            <td>
                                <form action="{{route('admin.deleteImages')}}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <input type="hidden" name="uid" value="{{$Gallery->id}}">
