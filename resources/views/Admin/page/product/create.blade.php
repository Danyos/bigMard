                ...
                <form method="POST" action="{{ route('admin.product.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="auction_end_time" class="form-control" value="{{ old('auction_end_time') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="status">
                            <option value="active" disabled>Publish</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control  inputFields ncontent" rows="4">{{ old('description') }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="imgText" id="imgText" class="form-control" required>{{ old('imgText') }}</textarea>
                                    @error('imgText')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" name="youtubeUrl" id="youtubeUrl" class="form-control" value="{{ old('youtubeUrl') }}">
                                    @error('youtubeUrl')
                                    <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
